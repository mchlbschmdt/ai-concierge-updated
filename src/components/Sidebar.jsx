...
import { Home, Users, Mail, LayoutList, Settings, Search, FileText, BarChart3, Building, MessageSquare, Phone } from "lucide-react";

const navItems = [
  { label: "Dashboard", path: "/dashboard", icon: Home },
  { label: "Properties", path: "/dashboard/properties", icon: Building },
  { label: "Property Manager", path: "/dashboard/properties-manager", icon: LayoutList },
  { label: "Guest Manager", path: "/dashboard/guests-manager", icon: Users },
  ...
  { label: "SMS Testing", path: "/dashboard/sms-testing", icon: Phone },
];
